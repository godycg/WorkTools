...
namespace WorkTools.Utils {
    internal class IniHelper {
        ...
        //public delegate void GetControlAfterOperationHandler(Control control);

        ///// <summary>
        ///// 递归遍历传入的控件，得到该控件的子控件，并对子控件进行操作
        ///// </summary>
        ///// <param name="fatherControl">传入的父控件</param>
        ///// <param name="getControlAfterOperationHandler">得到控件后对控件的具体操作</param>
        //public static void GetControls(Control fatherControl, GetControlAfterOperationHandler getControlAfterOperationHandler)
        //{
        //    Control.ControlCollection sonControls = fatherControl.Controls;
        //    //遍历所有控件
        //    foreach (Control ctr in sonControls)
        //    {
        //        //执行具体操作
        //        getControlAfterOperationHandler(ctr);
        //        if (ctr.Controls != null)
        //        {
        //            GetControls(ctr, getControlAfterOperationHandler);
        //        }
        //    }
        //}

        ///// <summary>
        ///// 委托：得到控件后对控件的具体操作,并可传入自定义字符串
        ///// </summary>
        ///// <param name="control">控件</param>
        ///// <param name="str">传入的自定义字符串</param>
        //public delegate void GetControlAfterOperationAndPassStringHandler(Control control, string str);

        ///// <summary>
        ///// 递归遍历传入的控件，得到该控件的子控件，并对子控件进行操作
        ///// </summary>
        ///// <param name="fatherControl">传入的父控件</param>
        ///// <param name="getControlAfterOperationAndPassStringHandler">得到控件后对控件的具体操作</param>
        ///// <param name="str">传入自定义字符串</param>
        //public static void GetControlsAndPassString(Control fatherControl, GetControlAfterOperationAndPassStringHandler getControlAfterOperationAndPassStringHandler, string str)
        //{
        //    Control.ControlCollection sonControls = fatherControl.Controls;
        //    //遍历所有控件
        //    foreach (Control ctr in sonControls)
        //    {
        //        //执行具体操作
        //        getControlAfterOperationAndPassStringHandler(ctr, str);
        //        if (ctr.Controls != null)
        //        {
        //            GetControlsAndPassString(ctr, getControlAfterOperationAndPassStringHandler, str);
        //        }
        //    }
        //}

        /// <summary>
        /// 判断文件是否存在，若不存在，根据路径及文件名创建文件。返回true表示创建了文件；返回false表示没有创建文件。
        /// </summary>
        /// <param name="path">ini文件路径</param>
        /// <returns>返回true表示‘不存在文件，所以创建了文件’；返回false表示‘存在文件，没有创建文件’</returns>
        public static bool IniCreate(string path) {
            bool result = false;
            if (!String.IsNullOrEmpty(path)) {
                string pathDir = Path.GetDirectoryName(path);       //对传入的文件路径提取其所在的目录
                if (!Directory.Exists(pathDir))                     //判断是否存在相关目录
                {
                    Directory.CreateDirectory(pathDir);             //不存在则创建该目录
                }
                if (!File.Exists(path))                             //判断是否存在相关文件
                {
                    FileStream fs = File.Create(path);               //不存在则创建ini文件
                    fs.Close();                                    //关闭文件，解除占用
                    result = true;
                }
            }
